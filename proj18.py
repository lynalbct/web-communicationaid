...
# change the set up of the database for your postgres(exactly below this)
app.config['SQLALCHEMY_DATABASE_URI'] = 'postgresql://postgres:coycoy6197@localhost/proj18'
...
def add():
    ...
    account=Account(type, username, email, password)
